...
function return_searchresults(){    //追加修正
  return "<a href='".SEARCH_RESULT."'>検索結果へ戻る</a>";
}
 ...
 */
// function form_value($name){ if(empty($_POST['name'])){ echo '';}
//   elseif(isset($_POST['mode']) && $_POST['mode']=='REINPUT'){
