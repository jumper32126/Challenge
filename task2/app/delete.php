...
<meta charset="UTF-8">
  ...
  <body><?php
    ...
    if(!isset ($_POST['mode']) || !$_POST['mode']=="delete"){//追加修正 直接アクセス禁止
    ...
    <form action="<?php echo RESULT_DETAIL; ?>" method="GET"> <? //追加修正 GETに変更?>
      <input type="submit" name="NO" value="いいえ"style="width:100px"> <? // 修正 詳細画面に戻るをいいえに変更?>
      <input type="hidden" name="id"  value=<?php echo $_POST['id']?>> <? //追加?>
